...
# France_full_data <- bind_rows(
#   read_parquet("output/full_data/France_2015.parquet"),
#   read_parquet("output/full_data/France_2016.parquet"),
#   read_parquet("output/full_data/France_2017.parquet"),
#   read_parquet("output/full_data/France_2018.parquet"),
#   read_parquet("output/full_data/France_2019.parquet"),
#   read_parquet("output/full_data/France_2020.parquet")
# )
...
gg <- gg_Nmin + labs(caption = "", subtitle = "mineral N", title = "", fill = "tons of N\nper km2") + 
  gg_Norg + labs(caption = "", subtitle = "organic N", title = "", fill = "tons of N\nper km2") + 
...
gg <- gg_Pmin + 
  labs(
    caption = "", subtitle = "mineral P", title = ""
    ) + 
  gg_Kmin + 
  labs(
    caption = "", subtitle = "mineral K", title = ""
    ) +
  plot_layout(ncol=1) 
f_save_graph_pdf_png(
